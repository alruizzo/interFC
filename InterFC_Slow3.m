...
dirData  = ['/Users/lmuresearchfellowship/Documents/Adriana/'...
    'LMU_Psychology/Projects/Svenja/Slow3_Young']; % where the data...
...
%   Networks of interest
    intNets  = [32, 42, 2, 3, 10, 4, 5, 40]; % Vector
    NetNames = {'COn-A', 'COn-I', 'RFPn',...
        'Vis-39', 'Vis-46', 'Vis-59', 'Vis-64', 'Vis-67'}; % Names
...
% E.g., if you want to use them outside of the script
% select the specific network numbers that you want the Z-value for

% Write manually the heading you want (content of cells)
Names_ExtractZval = {'RFP and ACC', 'RFP and INS', 'RFP and 39',...
    'RFP and 46', 'RFP and 59', 'RFP and 64', 'RFP and 67'}; 
ExtractZval = [];

for i = 1:size(fisherZCON,2)
    tempZval(1,1) = FullFisherZCON(3,1,i);
    tempZval(1,2) = FullFisherZCON(3,2,i);
    tempZval(1,3) = FullFisherZCON(3,4,i);
    tempZval(1,4) = FullFisherZCON(3,5,i);
    tempZval(1,5) = FullFisherZCON(3,6,i);
    tempZval(1,6) = FullFisherZCON(3,7,i);
    tempZval(1,7) = FullFisherZCON(3,8,i);
...
% Write manually the heading you want (content of cells)
Names_ExtractZval2 = {'ACC and 39', 'ACC and 46', 'ACC and 59',...
    'ACC and 64', 'ACC and 67', 'INS and 39', 'INS and 46',...
    'INS and 59', 'INS and 64', 'INS and 67'}; 
ExtractZval2 = [];

for i = 1:size(fisherZCON,2)
    tempZval(1,1) = FullFisherZCON(1,4,i);
    tempZval(1,2) = FullFisherZCON(1,5,i);
    tempZval(1,3) = FullFisherZCON(1,6,i);
    tempZval(1,4) = FullFisherZCON(1,7,i);
    tempZval(1,5) = FullFisherZCON(1,8,i);
    tempZval(1,6) = FullFisherZCON(2,4,i);
    tempZval(1,7) = FullFisherZCON(2,5,i);
    tempZval(1,8) = FullFisherZCON(2,6,i);
    tempZval(1,9) = FullFisherZCON(2,7,i);
    tempZval(1,10) = FullFisherZCON(2,8,i);
    tempZval = num2cell(tempZval);
