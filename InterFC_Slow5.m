...
dirData  = ['/Users/lmuresearchfellowship/Documents/Adriana'...
    '/LMU_Psychology/Projects/Svenja/Slow5_Young']; % where the data...
...
%   Networks of interest
    intNets  = [20, 7, 11, 2, 1, 5, 18]; % Vector
    NetNames = {'COn', 'RFPn', 'Vis-39', 'Vis-46', 'Vis-59',...
        'Vis-64', 'Vis-67'}; % Names
...
% Write manually the heading you want (content of cells)
Names_ExtractZval2 = {'CO and 39', 'CO and 46', 'CO and 59',...
    'CO and 64','CO and 67'};
ExtractZval2 = [];
